    ...
    async def help(self, ctx, commandName=None):
        ...
        if commandName is not None:
            ...
            if commandName2 is None:
                ...
                embed = discord.Embed(title=f"**{commandName2.name.upper()} COMMAND :**", description="[**GitHub**](http://www.thelandofark.com/Discord)", color=0xdeaa0c)
            ...
            embed = discord.Embed(title=f"__**Help page of {self.bot.user.name.upper()}**__", description="[**GitHub**](http://www.thelandofark.com/Discord)", color=0xdeaa0c)
            embed.set_thumbnail(url=f'{self.bot.user.avatar_url}')
